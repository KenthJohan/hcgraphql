...
namespace Demo
{
	public static class Testing
	{
		...
		public static void db_add_example(Demo_Context context)
		{
			...
			var tower1 = new Building{name="Tower1"};
			var tower2 = new Building{name="Tower2"};
			var Meredith = new User{name="Meredith"};
			...
			*/
			...
			/*
			var e1 = new Edge{a_id = Meredith.id, b_id = tower1.id};
			var e2 = new Edge{a_id = Meredith.id, b_id = tower2.id};
